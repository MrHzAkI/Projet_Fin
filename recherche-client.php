...
<body>
<form action="testrecherche-client.php" method=post>
<center><fieldset>
<legend><h2><u>Recherche par:</u></h2></legend>
<table border=2 bgcolor=pink bordercolor="yellow">
<tr><td><select name="liste">
...
</td><td><input type="text" name="txt" placeholder="id,code bien,type_materiel..."  required/></td></tr>
<tr><td colspan="2" align=center><input type=submit  value=Chercher><input type=reset  value=Effacer></td></tr>
